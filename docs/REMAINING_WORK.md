...
Last updated: **2026-08-05T04:00Z** — housing max raw **7.0** (web85) but **upload-ready NO** (Vimeo-fail→still slideshow); healthcare **6.6**. Vimeo probe + AI-illustration rejects shipped; durable requires upload YES. Loop continuing.
