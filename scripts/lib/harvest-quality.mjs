...
/**
 * Subject tokens for generic soft-pass meaning checks — topic keywords minus
 * weak filler (tiktok/news/footage) that never certify on-topic motion.
 *
 * @param {string} [topicBlob]
 * @returns {string[]}
 */
export function extractTopicSubjectTokens(topicBlob = '') {
  return extractKeywords(topicBlob, 12).filter((kw) => !WEAK_TOPIC_WORDS.has(kw));
}
