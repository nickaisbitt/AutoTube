...
const HEALTHCARE_HARD_REJECT_PATTERNS = [
  ...
  {
    // healthcare leftovers: Guerbet contrast-injection marketing clips and bare RSNA
    // conference presence. HEALTHCARE_OFF_TOPIC_BROLL_RE has narrower compound tokens
    // (guerbet\s+aimed, rsna\s+20\d{2}); broader patterns here catch variants.
    reason: 'guerbet-rsna-leftover',
    pattern: /\bguerbet\b|\brsna\b/i,
  },
];
