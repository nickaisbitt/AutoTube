...
export function checkIntroFacePool(project) {
  ...
  if (healthcare) {
    const hasIntroFace = videos.some((asset) => {
      ...
      // healthcare-web76: Science Nation is branding junk — never qualifies intro alone.
