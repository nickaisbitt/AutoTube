...
/**
 * Admission bar for harvested motion: only explicit KEEP clips ship.
 * WEAK establishing pads and REJECT junk must not reach the timeline.
 *
 * @param {'KEEP'|'WEAK'|'REJECT'|string|null|undefined} decision
 * @returns {boolean}
 */
export function shouldAdmitHarvestClip(decision) {
